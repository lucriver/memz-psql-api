...
app.post("/users", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { user_id, email, first_name, last_name, bio, avatar, location } = req.body;
    try {
        const newUser = yield pool.query(`
...
// Update post(s)
app.put("/posts/:user_id/:post_number", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const user_id = req.params.user_id;
...
app.get("/posts/:user_id/:filter", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const user_id = req.params.user_id;
...
app.get("/posts/:user_id/post/:post_number", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const user_id = req.params.user_id;
    const post_number = req.params.post_number;
    try {
        const post = yield pool.query(`
...
app.delete("/posts/:user_id/:filter", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const user_id = req.params.user_id;
    const filter = req.params.filter;
    if (filter == "all") {
        try {
...
app.delete("/posts/:user_id/post/:post_number", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const user_id = req.params.user_id;
    const post_number = req.params.post_number;
    try {
        yield pool.query(`
